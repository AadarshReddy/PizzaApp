...
using PizzaAppAssign.Models;

namespace PizzaAppAssign.Controllers
{
    public class PizzaController : Controller
    {
        private static readonly List<Pizza> PizzaTypes = new List<Pizza>
    {
        new Pizza { PizzaId = 1, PizzaType = "BBQ Pizza", Price = 600.00 },
        new Pizza { PizzaId = 2, PizzaType = "Prawn Pizza", Price = 499.60 },
        new Pizza { PizzaId = 3, PizzaType = "Cheese Pizza", Price = 300.00 },
        new Pizza { PizzaId = 4, PizzaType = "Chicken Pizza", Price = 800.00 },
        new Pizza { PizzaId = 5, PizzaType = "Mayonise Pizza", Price = 490.00 },
        new Pizza { PizzaId = 6, PizzaType = "Large Pizza", Price = 109.50 }
